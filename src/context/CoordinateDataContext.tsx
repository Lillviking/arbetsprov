...
export const CoordinateDataContext = createContext<{
    ...
    coordinateData: { latitude: 62.38, longitude: 17.30, name: "Sundsvall" }, // Startvärden här
    setCoordinateData: () => { },
});
...
export const CoordinateDataProvider: React.FC<ICoordinateDataProvider> = ({ children }) => {
